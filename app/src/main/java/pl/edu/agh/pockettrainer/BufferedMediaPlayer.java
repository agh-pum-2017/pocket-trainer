...
public class BufferedMediaPlayer {
    ...
    private static final String TAG = BufferedMediaPlayer.class.getName();
     ...
     * @return new instance
     */
    public static BufferedMediaPlayer create(Context context, int resId) {
        return new BufferedMediaPlayer(context, resId);
    }


    private BufferedMediaPlayer(Context context, int resId) {
        mContext = context;
        mResId = resId;
        try {
     ...
     * @return new instance
     */
    public static BufferedMediaPlayer create(Context context, String path) {
        return new BufferedMediaPlayer(context, path);
    }

    private BufferedMediaPlayer(Context context, String path) {
        mContext = context;
        mPath = path;
        try {
